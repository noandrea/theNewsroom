...
WITH (OIDS=FALSE);
ALTER TABLE "public"."feeds" OWNER TO "anchorman";
...
-- ----------------------------
DROP TABLE IF EXISTS "public"."article_country";
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."article_country" OWNER TO "anchorman";

-- ----------------------------
--  Table structure for articles_update
-- ----------------------------
DROP TABLE IF EXISTS "public"."articles_update";
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."articles_update" OWNER TO "anchorman";
...
WITH (OIDS=FALSE);
ALTER TABLE "public"."articles" OWNER TO "anchorman";

-- ----------------------------
--  View structure for top_countries
-- ----------------------------
DROP VIEW IF EXISTS "public"."top_countries";
...
-- ----------------------------
DROP VIEW IF EXISTS "public"."aggregate_article_country";
...
-- ----------------------------
DROP VIEW IF EXISTS "public"."articles_headlines";
...
-- ----------------------------
DROP VIEW IF EXISTS "public"."articles_headlines_feed";
...
-- ----------------------------
DROP VIEW IF EXISTS "public"."top_country_last_week";
...
-- ----------------------------
DROP VIEW IF EXISTS "public"."countries_keywords";
